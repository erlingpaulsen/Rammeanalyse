...
%
% boyespenning: Matrise med max bøyespenning i elementet
% tilhørende radindeks i kolonne 1. Posisjonen hvor max
% bøyespenning virker i kolonne 2
