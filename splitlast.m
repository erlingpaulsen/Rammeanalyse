        ...
        if last(i, 1) == 1;
            ...
            for j = 1 : length(knutepunkter);
                for k = j + 1 : length(knutepunkter);
                    if (elementnr(knutepunkter(j),...
                            knutepunkter(k), elem,...
                            length(elem(:,1))) > 0);
                        
                        [i1, i2] = finnintensitet(last(i,:),...
                      knutepunkter(j), knutepunkter(k), punkt);
                        nylast = [nylast; [1,...
                            knutepunkter(j),...
                            knutepunkter(k), i1, i2, 0]];
